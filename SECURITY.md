...
- **Key Derivation**: Master Key derivation uses **PBKDF2** with **800,000 iterations** (with silent auto-migration from legacy 100,000 iteration vaults) and a unique 16-byte random salt per vault.
